...
iCalEvent.prototype = {
	...
	toFile: function(){
		...
		result += 'ORGANIZER;CN="' + this.event.organizer.name + '":mailto:' + this.event.organizer.email + '\r\n';
		result += 'DTSTART;TZID=' + 'Pacific/Auckland' + ':' + this.event.starts + '\r\n';
		result += 'DTEND;TZID=' + 'Pacific/Auckland' + ':' + this.event.ends + '\r\n';
